    ...
    public static void main(String[] args) throws IOException {
        ...
        for (Person person : people) {
            if (person.getName().equals(targetName)) {
                ...
                sb.append("Google.Company:").append(System.lineSeparator());
                if (person.getCompany() != null) {
                    sb.append(person.getCompany().toString()).append(System.lineSeparator());
                }

                sb.append("Google.RawData.CarSalesman.Car:").append(System.lineSeparator());
                if (person.getCar() != null) {
                    sb.append(person.getCar().toString()).append(System.lineSeparator());

                }

                sb.append("Google.Pokemon:").append(System.lineSeparator());
